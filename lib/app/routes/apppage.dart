...
import 'package:flutter_application_ecommerce/screen/profile_information/profile_inforamtion_binding.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(name: AppRoutes.profileinformation, page: () => ProfileInformationView (), 
