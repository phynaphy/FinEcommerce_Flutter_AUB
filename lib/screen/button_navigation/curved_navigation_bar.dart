...
import 'package:flutter_application_ecommerce/screen/button_navigation/nav_custom_clipper.dart';
import 'package:flutter_application_ecommerce/screen/button_navigation/nav_custom_painter.dart';
...
class CurvedNavigationBar extends StatefulWidget {
  ...
  CurvedNavigationBar({
    ...
    required this.items,
    this.index = 0,
    this.color = const Color.fromARGB(255, 90, 127, 175),
